...
public class GastosAdapter extends RecyclerView.Adapter<GastosAdapter.MyViewHolder> {
    ...
    public GastosAdapter(Context mContext, List<Wallet> mData) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = mInflater.inflate(R.layout.gastocard,parent,false);

        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(GastosAdapter.MyViewHolder holder, final int position) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            title = (TextView)itemView.findViewById(R.id.itemgasto);
            descricao = (TextView)itemView.findViewById(R.id.dinheirogasto);
            data = (TextView)itemView.findViewById(R.id.dategasto);

            card = itemView.findViewById(R.id.gastocard);
